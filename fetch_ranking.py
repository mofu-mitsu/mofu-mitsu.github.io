...
def fetch_top_pages():
    ...
    tool_map = {
        ...
        'cafe-polr': {'name': 'ソシオニクス脆弱診断', 'desc': 'アキレス腱となる「脆弱な機能(PoLR)」を判定。', 'url': 'https://mofu-mitsu.github.io/cafe-polr/'},
        'dcnh-chronos-protocol': {'name': 'DCNH診断', 'desc': 'DCNHサブタイプとソシオ自認を掛け合わせて分析。', 'url': 'https://dcnh-chronos-protocol.vercel.app/'},
        'twin-mirror': {'name': 'Twin Mirror', 'desc': '準同一関係を解き明かす双子診断。', 'url': 'https://mofu-mitsu.github.io/twin-mirror/'},
        'crystal-origin': {'name': 'CRYSTAL ORIGIN', 'desc': '直感の光から内なる原石を鑑定する宝石診断。', 'url': 'https://crystal-origin.vercel.app/'},
        ...
        'nightscape-tritype': {'name': 'Nightscape Tritype', 'desc': 'トライタイプと生得本能を網羅した本格診断。', 'url': 'https://mofu-mitsu.github.io/nightscape-tritype/'},
